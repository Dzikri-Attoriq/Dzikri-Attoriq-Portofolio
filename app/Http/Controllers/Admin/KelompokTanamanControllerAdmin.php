...
class KelompokTanamanControllerAdmin extends Controller
{
    public function index()
    {
        $data['kelompok_tanamans'] = Kelompok_tanaman::with('jenis_pohon')->paginate();
        $data['title'] = "Kelompok Tanaman";
        return view('admin.master_data.kelompok_tanaman.index', $data);
    }

    public function create()
    {
        $data['title'] = "Tambah Kelompok Tanaman";
        return view('admin.master_data.kelompok_tanaman.tambah', $data);
    }
    ...
    public function edit(Kelompok_tanaman $kelompok_tanaman)
    {
        ...
        return view('admin.master_data.kelompok_tanaman.edit', $data);
    }
