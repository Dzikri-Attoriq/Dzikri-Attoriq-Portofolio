...
class PengelolaControllerAdmin extends Controller
{
    public function index()
    {
        $data['data_pengelolas'] = Pengelola::orderBy('nama')->paginate();
        $data['title'] = "Data Pegnelola";
        return view('admin.master_data.data_pengelola.index', $data);
    }

    public function create()
    {
        $data['title'] = "Tambah Data Pengelola";
        return view('admin.master_data.data_pengelola.tambah', $data);
    }
    ...
    public function edit(Pengelola $data_pengelola)
    {
        ...
        return view('admin.master_data.data_pengelola.edit', $data);
    }
