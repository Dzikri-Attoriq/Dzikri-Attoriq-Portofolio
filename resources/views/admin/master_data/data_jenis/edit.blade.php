            ...
            <div class="col-12" >
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit Jenis Pohon</h4>
                    </div>
                    
                    <div class="card-body">
                        <form action="/data-jenis/{{ $data_jenis->nama }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('nama', $data_jenis->nama) }}">
                                        @error('nama')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="deskripsi" type="hidden" name="deskripsi" value="{{ old('deskripsi', $data_jenis->deskripsi) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="manfaat" type="hidden" name="manfaat" value="{{ old('manfaat', $data_jenis->manfaat) }}">
                                        ...
                                        @enderror" name="kelompok_tanaman_id" id="kelompok_tanaman_id">
                                            ...
                                            @foreach ($kelompok_tanamans as $kelompok_tanaman)
                                                <option value="{{ $kelompok_tanaman->id }}"
                                                    {{ old('kelompok_tanaman_id', $data_jenis->kelompok_tanaman_id) == $kelompok_tanaman->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror" id="status" name="status">
                                            <option value=" "></option>
                                            <option value="Indoor" {{ old('status', $data_jenis->status) == 'Indoor' ? 'selected' : '' }}>Indoor</option>
                                            <option value="Outdoor" {{ old('status', $data_jenis->status) == 'Outdoor' ? 'selected' : '' }}>Outdoor</option>
                                        </select>
                                        @error('status')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('storage/' . $data_jenis->image) }}" class="img-preview img-fluid d-block col-sm-4 mb-2">
