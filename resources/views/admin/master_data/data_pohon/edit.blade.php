            ...
            <div class="col-12" >
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit Data Pohon</h4>
                    </div>
                    
                    <div class="card-body">
                        <form action="/data-pohon/{{ $data_pohon->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('umur_pohon', $data_pohon->umur_pohon) }}">
                                        @error('umur_pohon')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="koordinat" name="koordinat"
                                        value="{{ old('koordinat', $data_pohon->koordinat) }}"  onchange="moveMarkerToCoordinates()">
                                    @error('koordinat')
                                        <small class="text-danger ms-3 fst-italic">
                                            {{ $message }}
                                        </small>
...
const map = L.map('map').setView([{{ $data_pohon->koordinat }}], 19);
...
function moveMarkerToCoordinates() {
    ...
    if (!isNaN(latitude) && !isNaN(longitude) && latitude >= -90 && latitude <= 90 && longitude >= -180 && longitude <= 180) {
        ...
        document.getElementById('koordinat').value = "{{ $data_pohon->koordinat }}";
        if(marker != undefined) {
            map.removeLayer(marker);
        }
    }
