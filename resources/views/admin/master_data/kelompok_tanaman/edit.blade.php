...
<section id="input-style">
    <div class="container d-flex align-items-center justify-content-center">
        <div class="row w-100">
            <div class="col-12" >
                <div class="card">
                    <a href="/kelompok-tanaman"><i class="bi bi-chevron-left p-3"></i></a>
                    <div class="card-header">
                        <h4 class="card-title">Edit Kelompok Tanaman</h4>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="nama">Kelompok Tanaman<span class="text-danger">*</span></label>
                                        <input type="text" id="nama" name="nama" class="form-control round @error('nama')
                                        is-invalid
                                        @enderror" value="{{ old('nama', $kelompok_tanaman->nama) }}">
                                        @error('nama')
