...
<section id="input-style">
    <div class="container d-flex align-items-center justify-content-center">
        <div class="row w-100">
            <div class="col-12" >
                <div class="card">
                    <a href="/status-kawasan"><i class="bi bi-chevron-left p-3"></i></a>
                    <div class="card-header">
                        <h4 class="card-title">Edit Status Kawasan</h4>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="nama">Status Kawasan<span class="text-danger">*</span></label>
                                        <input type="text" id="nama" name="nama" class="form-control round @error('nama')
                                        is-invalid
                                        @enderror" value="{{ old('nama', $status_kawasan->nama) }}">
                                        @error('nama')
