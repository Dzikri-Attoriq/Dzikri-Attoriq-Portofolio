...
<section class="section-1">
    <div class="page-heading">
        <h5>Admin</h5>
        <a href="/admin/create" class="btn btn-primary btn-sm" title="Tambah">
    ...
    <div class="cards-wrapper-1">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card-1">
                    <img src="{{ asset('storage/' . $admin->image) }}" class="card-img-top-1" alt="Tree">
                    <p class="card-title-1">{{ $admin->nama }}</p>
                    <small class="top-title-1">{{ $admin->email }}</small>
                    <div class="card-title-1 text-end">
                        <a href="" class="btn btn-light btn-sm" id="set_dtl"
                            data-bs-toggle="modal" data-bs-target="#detail-admin"
                        ...
                        <form action="/admin/{{ $admin->email }}" method="POST"
                            class="d-inline">
                            @method('delete')
                            @csrf
  ...
  <div class="modal fade detail" id="detail-admin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="judul-modal" id="exampleModalLabel">Detail Admin</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="row">
              <div class="col-lg-6 col-md-12 d-flex justify-content-center">
                <img src="" class="img-fluid img-modal" id="image-modal" alt="Gambar Admin">
              </div>
