...
<section id="input-style">
    <div class="container d-flex align-items-center justify-content-center">
        <div class="row w-100">
            <div class="col-12" >
                <div class="card">
                    <a href="/user"><i class="bi bi-chevron-left p-3"></i></a>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('nama', $user->nama) }}">
                                        @error('nama')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" id="alamat" name="alamat" rows="3">{{ old('alamat', $user->alamat) }}</textarea>
                                        @error('nama')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('instagram', $user->instagram) }}">
                                        @error('instagram')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <img src="{{ asset('storage/' . $user->image) }}" class="img-preview img-fluid d-block col-sm-4 mb-2">
