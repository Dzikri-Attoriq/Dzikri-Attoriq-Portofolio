...
<section id="input-style">
    <div class="container d-flex align-items-center justify-content-center">
        <div class="row w-100">
            <div class="col-12" >
                <div class="card">
                    <a href="/profile-admin"><i class="bi bi-chevron-left p-3"></i></a>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('nama', Auth::user()->nama) }}">
                                        @error('nama')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" id="alamat" name="alamat" rows="3">{{ old('alamat', Auth::user()->alamat) }}</textarea>
                                        @error('nama')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('no', Auth::user()->no) }}">
                                        @error('no')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror" value="{{ old('instagram', Auth::user()->instagram) }}">
                                        @error('instagram')
                                            <small class="text-danger ms-3 fst-italic">
                                                {{ $message }}
                                            </small>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <img src="{{ asset('storage/' . Auth::user()->image) }}" class="img-preview img-fluid d-block col-sm-4 mb-2">
