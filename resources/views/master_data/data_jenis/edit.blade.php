    ...
    <div class="main-wrapper">
        <div class="row">
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Data Jenis Pohon</h5>
                        <form action="/data-jenis/{{ $data_jenis->nama }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $data_jenis->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <small class="form-text text-muted text-danger pl-3"
                                        style="font-style: italic">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('storage/' . $data_jenis->image) }}" class="img-preview img-fluid col-sm-4 mb-2">
