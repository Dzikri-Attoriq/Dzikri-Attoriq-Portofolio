  ...
  <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
            <form id="tambah-pohon-form" action="/tambah-pohon" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 mb-2">
                        <label for="jenis_pohon_id" class="label-size">Jenis Pohon<span class=" text-danger">* </span></label>
                    ...
                    <div class="col-12 mb-2">
                        <label for="kawasan_id" class="label-size">Kawasan<span class=" text-danger">* </span></label>
                        <div class="form-group">
                    ...
                    <div class="col-12 mb-2">
                        <label for="status_kawasan_id" class="label-size">Status Kawasan<span class=" text-danger">* </span></label>
                        <div class="form-group">
                    ...
                    <div class="col-12 mb-2">
                        <label for="umur_pohon" class="label-size">Umur Pohon<span class=" text-danger">* </span></label>
                        <div class="form-group">
                    ...
                    <div class="col-12 mb-2">
                        <label for="pengelola_id" class="label-size">Pengelola<span class=" text-danger">* </span></label>
                        <div class="form-group">
                    ...
                    <div class="col-12 mb-2">
                        <label for="koordinat" class="label-size">Koordinat Pohon<span class=" text-danger">* </span> <span>(perkelompok tanam)</span></label>
                        ...
                        <a href="https://www.google.com/maps/" class="btn btn-light btn-submit" target="_blank">
                            Buka Maps
                        </a>
                    </div>
...
function submitForm() {
    ...
    document.getElementById('jenis_pohon_id_error').innerHTML = '';
    document.getElementById('kawasan_id_error').innerHTML = '';
    document.getElementById('status_kawasan_id_error').innerHTML = '';
    document.getElementById('umur_pohon_error').innerHTML = '';
    document.getElementById('pengelola_id_error').innerHTML = '';
    document.getElementById('koordinat_error').innerHTML = '';

    // Mendapatkan nilai koordinat dari input
    const koordinatInput = document.getElementById('koordinat').value;

    // Membuat regular expression untuk memeriksa format koordinat
    const koordinatRegex = /^[-+]?\d+(\.\d+)?, [-+]?\d+(\.\d+)?$/;
    
    // Mengirimkan formulir dengan Fetch API
    if (!koordinatRegex.test(koordinatInput)) {
        // Format koordinat tidak sesuai
        document.getElementById('koordinat_error').innerHTML = 'Format koordinat tidak valid. Gunakan format "latitude, longitude".';
    }
    ...
    .then(data => {
        if (data.errors) {
            ...
            $('#jenis_pohon_id').empty();
            document.getElementById("kawasan_id").options.length = ' ';

            // var jenis_pohon_id = document..querySelectorAll('#jenis_pohon_id option');
            //     jenis_pohon_id.forEach(o => o.remove());
            // document.getElementById('kawasan_id').selectedIndex = 0;
            document.getElementById('status_kawasan_id').removeAttribute('selected');;
            document.getElementById('umur_pohon').value = '';
            document.getElementById('pengelola_id').innerHTML = null;
