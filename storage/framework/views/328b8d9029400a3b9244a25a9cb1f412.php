    ...
    <div class="main-wrapper">
        <div class="row">
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Status Kawasan</h5>
                        <form action="/status-kawasan/<?php echo e($status_kawasan->nama); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama"
                                    value="<?php echo e(old('nama', $status_kawasan->nama)); ?>">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\App-pohon-DLH\resources\views/status_kawasan/edit.blade.php ENDPATH**/ ?>