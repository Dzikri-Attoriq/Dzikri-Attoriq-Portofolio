            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/user/<?php echo e($user->email); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3"><?php echo e(old('alamat', $user->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no" name="no"
                                    value="<?php echo e(old('no', $user->no)); ?>" placeholder="896xxxxxxxx">
                                <?php $__errorArgs = ['no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="instagram" name="instagram"
                                    value="<?php echo e(old('instagram', $user->instagram)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control" id="role" name="role">
                                    ...
                                    <option value="1" <?php echo e(old('role', $user->role) == '1' ? 'selected' : ''); ?>>Manajemen User</option>
                            ...
                            <div class="form-group">
                                ...
                                <img src="<?php echo e(asset('storage/' . $user->image)); ?>" class="img-preview img-fluid col-sm-4 mb-2">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\App-pohon-DLH\resources\views/settings/user/edit.blade.php ENDPATH**/ ?>