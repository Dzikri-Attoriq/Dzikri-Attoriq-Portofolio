                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="card col-md-4" style="width: 18rem;">
                                <img src="<?php echo e(asset('storage/' . $jenis_pohon->image)); ?>" class="card-img-top img-fluid" style="height: 230px" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title"><?php echo e($jenis_pohon->nama); ?></h5>
                                  <a href="" class="btn btn-default btn-xs" id="set_dtl"
                                    ...
                                    <a href="/data-jenis/<?php echo e($jenis_pohon->nama); ?>/edit"
                                        class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit" title="Edit"></i>
                                    </a>
                                    <form action="/data-jenis/<?php echo e($jenis_pohon->nama); ?>" method="POST"
                                        class="d-inline">
                        ...
                        <div class=""><?php echo e($jenis_pohons->links()); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\App-pohon-DLH\resources\views/master_data/data_jenis/view.blade.php ENDPATH**/ ?>